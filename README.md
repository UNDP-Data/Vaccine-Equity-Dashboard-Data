...
| <code>vaccinesdelivered</code>      | Vaccines Delivered (total)| Absolute number of vaccine doses delivered to a country.| [UNICEF COVID-19 Market Dashboard](https://www.unicef.org/supply/covid-19-market-dashboard) |
| <code>vaccinesdelivered_lag</code>      | Vaccines Delivered (total)-Lagged | Absolute number of vaccine doses delivered to a country as of 14 days prior to the latest update.| [Multilateral Leaders Task Force on COVID-19](https://data.covid19taskforce.com/data/tools/vaccine-delivery) |
...
| <code>total_donations</code>     | Number of vaccine doses received through bilateral or multilateral donations.| Absolute number of vaccine doses received through bilateral or multilateral donations. | [UNICEF COVID-19 Market Dashboard](https://www.unicef.org/supply/covid-19-market-dashboard) |
| <code>utilrate_lag</code>     | Percentage administered of total delivered vaccines | Percentage of the delivered vaccines that have been administered. A two-week lag is used for delivered vaccines to allow for delivery lead time.| [UNICEF COVID-19 Market Dashboard](https://www.unicef.org/supply/covid-19-market-dashboard) |
...
| <code>v3_vaccinefinancialsupportsummar</code>     | Vaccine financial support | Records how vaccines are funded for each category of people identified in V2 as currently receiving vaccines. <br> Blank - no data <br> 0 - No availability <br> 1 - Full cost to everyone eligible <br> 2 - Full cost to some groups, partially government subsidised for other categories <br> 3 - Partially government-funded for everyone eligible <br> 4 - Partial government funding for some eligible groups, full funding for others <br> 5- All eligible groups are fully government funded |[OxCGRT](https://www.bsg.ox.ac.uk/research/research-projects/covid-19-government-response-tracker) |
| <code>v3_name</code>  | Vaccine financial support classification | Vaccine financial support classification |[OxCGRT](https://www.bsg.ox.ac.uk/research/research-projects/covid-19-government-response-tracker) |
...
| <code>casesnewlyreportedinlast7days</code>   | Cases - newly reported in last 7 days | Cases - newly reported in last 7 days|[WHO](https://covid19.who.int/info/) |
| <code>cumulative_cases</code>   | The cumulative number of cases a country has recorded. | The cumulative number of cases a country has recorded.|[WHO](https://covid19.who.int/info/) |
...
| <code>new_deaths</code>   | New deaths attributed to COVID-19. | New deaths attributed to COVID-19 (last 24h). |[WHO](https://covid19.who.int/info/) |
| <code>cumulative_deaths</code>   | The cumulative number of deaths a country has recorded. | The cumulative number of deaths a country has recorded. |[WHO](https://covid19.who.int/info/) |
| <code>deathsnewlyreportedinlast7days</code>   | Deaths - newly reported in last 7 days | Deaths - newly reported in last 7 days |[WHO](https://covid19.who.int/info/) |
...
| <code>total_vaccinations</code>   | Number of vaccines administered (total) | Number of vaccines administered (total) |[WHO](https://covid19.who.int/info/) |
...
| <code>persons_vaccinated_1plus_dose</code>   | Absolute number of persons who have received at least one vaccine dose. | Absolute number of persons who have received at least one vaccine dose. |[WHO](https://covid19.who.int/info/) |
...
| <code>persons_fully_vaccinated</code>   | Absolute number of persons who have received a full vaccine course. | Absolute number of persons who have received a full vaccine course. |[WHO](https://covid19.who.int/info/) |
| <code>vaccines_used</code>   | Vaccine products that have been in use. | Vaccine products that have been in use. |[WHO](https://covid19.who.int/info/) |
...
| <code>total_boosters</code>   | Total number of COVID-19 vaccination booster doses administered (doses administered beyond the number prescribed by the vaccination protocol) | Total number of COVID-19 vaccination booster doses administered (doses administered beyond the number prescribed by the vaccination protocol) |[OWID](https://github.com/owid/covid-19-data/tree/master/public/data/vaccinations) |
