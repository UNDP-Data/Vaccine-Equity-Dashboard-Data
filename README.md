...
| <code>total_donations</code>     | Number of vaccine doses received through bilateral or multilateral donations.| Absolute number of vaccine doses received through bilateral or multilateral donations. |Records the number of received vaccine donations as a percentage of all vaccine deliveries.| [IMF-WHO-COVID-19-Vaccine-Supply-Tracker](https://www.imf.org/en/Topics/imf-and-covid19/IMF-WHO-COVID-19-Vaccine-Supply-Tracker) |
...
| <code>v3_name</code>  | Vaccine financial support classification | ReVaccine financial support classification |[OxCGRT](https://www.bsg.ox.ac.uk/research/research-projects/covid-19-government-response-tracker) |
