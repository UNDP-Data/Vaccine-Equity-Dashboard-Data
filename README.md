...
| <code>vaccinesdelivered</code>      | Vaccines Delivered (total)| Absolute number of vaccine doses delivered to a country.| [Multilateral Leaders Task Force on COVID-19](https://data.covid19taskforce.com/data/tools/vaccine-delivery) |
...
| <code>total_donations</code>     | Number of vaccine doses received through bilateral or multilateral donations.| Absolute number of vaccine doses received through bilateral or multilateral donations. | [IMF-WHO-COVID-19-Vaccine-Supply-Tracker](https://www.imf.org/en/Topics/imf-and-covid19/IMF-WHO-COVID-19-Vaccine-Supply-Tracker) |
